...
public class MatchSetupTests : RuntimeServiceTest
{
    ...
    {
        MatchSetup setup = RegisterRuntime(new MatchSetup());
        ...
        Assert.Equal(5,
            Assert.IsType<ScoreTargetRules>(setup.Config.Rules.EndCondition).Target);
    ...
    public void CopyConfigGivesEditorsAnIndependentConfig()
    {
        ...
        Assert.IsType<ScoreTargetRules>(copy.Rules.EndCondition).Target = 123;
