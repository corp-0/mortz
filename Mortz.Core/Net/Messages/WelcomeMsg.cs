...
public readonly partial record struct WelcomeMsg(string MapId, string MapHash, byte[] Config,
    byte TerrainEncoding, int TerrainTransferId, int TerrainBytes, short TerrainChunks);
