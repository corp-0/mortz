...
public class ClientPlayersTests : RuntimeServiceTest
{
    ...
    {
        ClientPlayers first = RegisterRuntime(new ClientPlayers());
        ClientPlayers second = RegisterRuntime(new ClientPlayers());
