...
namespace Mortz.Protocol.Net.Match;
...
public readonly partial record struct EndMatchRequestMsg(
    ulong Sequence,
    byte[] Tag, int MatchGeneration = 0);
...
[NetMessage(NetChannel.RELIABLE, NetDirection.SERVER_TO_CLIENT)]
public readonly partial record struct MatchEndMsg(bool ByTeam, int WinnerId, int MatchGeneration = 0);
